...
Usage
-----
  python nhl_ytd_stats_v3.py --seasons 2011 2026 --outdir data
  python nhl_ytd_stats_v3.py --seasons 2011 2026 --outdir data --season-types 2 3
"""
...
def main() -> int:
    ...
    cal_goals, cal_xg, factors = 0.0, 0.0, []
    for season in range(first, last + 1):
        ...
        factor = (cal_goals / cal_xg) if cal_xg > 0 else 1.0
        cal_goals += raw_goals
        cal_xg += raw_xg
        if factor != 1.0:
